 ...
 -->                    </a>
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="row-content am-cf">
   	  	...
   	  	<form class="form-horizontal" action ="updatepwd.action" method="post"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder=""  value="" name = "oldPwd">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
        <input type="text" name="staffPwd" class="form-control"   value="">
        </div>
    </div>
 
      <button type="submit" class="form-control" class="btn btn-primary"
      style="width: 50%;margin-left: 255px;">修改密码</button>  
