...
<head>
    ...
    <title>菜单管理</title>
    <meta name="description" content="这是一个 菜单管理页面">
 ...
 -->                    </a>
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="row-content am-cf">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">添加一级表单</div>
                            </div>
                           <!--  菜单表格 -->
   	  	...
   	  	<form class="form-horizontal" action ="uerMenuInto2.action" method="post"
   	  	 style="width: 50%;margin-left: 385px;">
    <input type="hidden" name="menuId" value="${Tbmenu.menuId} " />
    ${Tbmenu.menuId} 
    <div class="form-group">
        <label for="" class="col-sm-2 control-label" style="margin-left: -295px;width: 50%;">
                 一级菜单:</label>
        <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder="" readonly="readonly" value="${Tbmenu.menuName}" name = "">
        </div>
    </div>
    <div class="form-group">
        <label for="" class="col-sm-2 control-label" style="margin-left: -295px;width: 50%;">
                 二级菜单:</label>
        <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder=""  value="" name = "menu2">
        </div>
    </div>
   
      <button type="submit" class="form-control" class="btn btn-primary"
      style="width: 50%;margin-left: 87px;">添加</button>  
