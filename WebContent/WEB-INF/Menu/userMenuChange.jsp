...
<!--                         <span class="am-badge am-badge-secondary sidebar-nav-link-logo-ico am-round am-fr am-margin-right-sm">6</span>
 -->                    </a>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">菜单表单</div>
                            </div>
                           <!--  菜单表格 -->
        ...
        <tr class="success">
            ...
            <th>一级菜单
            <a class="btn btn-success btn-xs" href="userMenuAddone.action">
	                          添加一级菜单
	        </a>
            </th>
            <th>二级菜单</th>
      ...
      <c:forEach items="${tbMenuslist}" var="menu"> 
	        <tr>
	            <!--  一级菜单 -->
	            <td> 
	             <c:if test="${menu.getMenuPid() == 0 }">
	             ${menu.getMenuName()}
	             </c:if>
	            </td>
	           <!--  二级菜单 -->
	            ...
	            <td>
	            <a class="btn btn-success btn-xs" href="Menudelete.action?menuId=${menu.menuId}">
	                          删除
	            </a>
	            <c:if test="${menu.getMenuPid() ==0  }">
	            <a class="btn btn-success btn-xs" href="userMenuAddtow.action?menuId=${menu.menuId}">
	                          添加二级菜单
	            </a>
	            </c:if>
