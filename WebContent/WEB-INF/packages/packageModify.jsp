                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">套餐修改</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="modifyPost.action" onsubmit="return packageCheck2();" method="post">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input name="paTime" value="${pack.paTime }" 
                                            type="text" class="tpl-form-input" id="time" readonly="readonly">
                                            <small>套餐时长不可修改</small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="money" class="am-u-sm-3 am-form-label">
												修改套餐价格
                                            <span class="tpl-form-line-small-title">¥</span>
                                        </label>
                                        <div class="am-u-sm-9">
                                            <input name="paPrice" value="${pack.paPrice }" type="text" class="tpl-form-input" id="money" placeholder="请输入...">
                                            <small>请输入整数，以元为单元</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            ...
                                            <button type="reset" class="am-btn am-btn-warning tpl-btn-bg-color-success ">重置</button>
                                        </div>
                                    </div>
