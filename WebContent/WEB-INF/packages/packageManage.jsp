                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">套餐管理</div>
                            </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button onclick="window.location.href='add.action'" 
                                                type="button" class="am-btn am-btn-default am-btn-success">
                                                <span class="am-icon-plus"></span>套餐办理</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="modify.action?paId=${pack.paId }&curPage=${page.curPage}">
                                                            <i class="am-icon-pencil"></i> 修改
                                                        </a>
                                                        <a href="delete.action?paId=${pack.paId }&curPage=${page.curPage}"
