                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">新增套餐</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="addPost.action" onsubmit="return packageCheck();" method="post">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input name="paTime" type="text" class="tpl-form-input" id="time" placeholder="请输入整数...">
                                            <small id="timeCheck">请按月份作为最小单位,且不大于2位</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input name="paPrice" type="text" class="tpl-form-input" id="money" placeholder="请输入...">
