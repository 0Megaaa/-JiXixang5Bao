                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">月缴会员办理</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="addPost.action" method="post" onsubmit="return checkAdd();" class="am-form tpl-form-line-form">
                                    <div class="am-form-group">
                                        <label for="carNum" class="am-u-sm-3 am-form-label">请输车牌号</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="carNum" id="carNum"  placeholder="请输入车牌号，例如闽D88888">
                                            <small id="carNumCheck"></small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="user-phone" class="am-u-sm-3 am-form-label">请选择套餐</label>
                                        <div class="am-u-sm-9">
                                            <select  name="paId" id="pack" data-am-selected="{searchBox: 1}" style="display: none;">
                                                <option value="0">请按照选择套餐</option>
												<c:forEach items="${packagesSelect }" var="pack">
													<option value="${pack.paId }">${pack.paTime }个月</option>
												</c:forEach>
                                            </select>
                                            <small>套餐价格</small>
                                            <small id="packageMsg" style="color:red">__</small>
                                            <small>元</small>
                                        </div>
                                    </div>
