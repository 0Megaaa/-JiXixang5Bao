                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="modifyDo.action"  id="form" name="form" method="post">
                                
                                
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">规则名称 <span class="tpl-form-line-small-title"></span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="ruleName" class="tpl-form-input" id="user-name"  value="${rule.ruleName}">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="passfh" class="tpl-form-input" id="user-name" value="${rule.passfh}">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="pass3h" class="tpl-form-input" id="user-name"  value="${rule.pass3h}">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="pass5h" class="tpl-form-input" id="user-name"  value="${rule.pass5h}">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="pass8h" class="tpl-form-input" id="user-name"  value="${rule.pass8h}">
