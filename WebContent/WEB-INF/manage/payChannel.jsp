...
<body data-type="chart">
    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-content-wrapper">
                                ...
                                <form class="am-form tpl-form-line-form"    id="myForm" name="form" method="post">
                                
                                
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">查询年份<span class="tpl-form-line-small-title">Title</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="year" class="tpl-form-input"   >
                                            <small>请输入年份</small>
                                        </div>
                                    </div>
